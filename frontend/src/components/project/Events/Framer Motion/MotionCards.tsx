  ...
  return (
    ...
    >
      ...
      >
        ...
        />
        <div className="absolute top-0 left-0 right-0 bg-black/40 backdrop-blur-md text-white text-center opacity-100 group-hover: transition-all duration-300 ease-out rounded-b-[20px] px-4 py-5">
